...
@btnPrimaryBackgroundHighlight:     Flxn(@btnPrimaryBackground, 15%);
...
@warningBorder:           darken(Flxn(@warningBackground, -10), 3%);

@errorText:               darken(#C45559, 5%);
@errorBackground:         #F2BDB1;
@errorBorder:             darken(Flxn(@errorBackground, -10), 3%);

@successText:             darken(@green, 5%);
@successBackground:       #D5ECBF;
@successBorder:           darken(Flxn(@successBackground, -10), 5%);

@infoText:                darken(@blue, 10%);
@infoBackground:          #A7DFF1;
@infoBorder:              darken(Flxn(@infoBackground, -10), 7%);
